...
function withCORS(headers, request) {
  ...
  // var url = request.corsAnywhereRequestState.location.path;
  ...
  headers['origin'] = 'https://social-network-project-mu.vercel.app';
  headers['access-control-allow-origin'] = 'https://social-network-project-mu.vercel.app';
  headers['access-control-allow-origin'] = 'https://social-network-project-mu.vercel.app';
  headers['Access-Control-Allow-Credentials'] = 'true';

  if (true || url.startsWith('/v2')) {
...
function proxyRequest(req, res, proxy) {
  ...
  req.headers['access-control-allow-origin'] = 'https://localhost:3000';
