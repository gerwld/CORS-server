...
function withCORS(headers, request) {
  ...
  headers['origin'] = 'http://network-project-pjaw.herokuapp.com';
  headers['access-control-allow-origin'] = 'http://network-project-pjaw.herokuapp.com';
  headers['access-control-allow-origin'] = 'https://network-project-pjaw.herokuapp.com';
